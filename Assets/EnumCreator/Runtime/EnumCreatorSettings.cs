...
namespace EnumCreator
{
    ...
    public class EnumCreatorSettings : ScriptableObject
    {
        ...
        [SerializeField] private bool includeTooltips = false;
        ...
        [Tooltip("When enabled, enable/disable checkboxes and labels will be shown for each enum value in the inspector. This allows you to temporarily disable enum values without removing them.")]
        [SerializeField] private bool showEnableDisableControls = false;
        ...
        public bool ShowEnableDisableControls => showEnableDisableControls;
        ...
        public bool MutableShowEnableDisableControls
        {
            get => showEnableDisableControls;
            set => showEnableDisableControls = value;
        }
